 ...
 * @see Hierarchical
 */
public abstract class AbstractHierarchicalBeanContainer<IDTYPE, BEANTYPE> extends BeanContainer<IDTYPE, BEANTYPE>
     ...
     */
    public AbstractHierarchicalBeanContainer(Class<BEANTYPE> type, AbstractBeanContainer<IDTYPE, BEANTYPE> container) {
        super(type);
    ...
    public void containerItemSetChange(ItemSetChangeEvent event) {
        ...
        if (hierarchicalBeanBuilder != null) {
            ...
            for (IDTYPE itemId : container.getItemIds()) {
                ...
                Collection<IDTYPE> ids = hierarchicalBeanBuilder.getChildren(bean);
     ...
     */
    public void setHierarchicalBeanBuilder(HierarchicalBeanBuilder<IDTYPE, BEANTYPE> hierarchicalBeanBuilder) {
    ...
    @Override
    public BeanItem<BEANTYPE> addBeanAfter(IDTYPE previousItemId, BEANTYPE bean) throws IllegalStateException,
            IllegalArgumentException {
        return container.addBeanAfter(previousItemId, bean);
    }

    @Override
    public BeanItem<BEANTYPE> addBeanAt(int index, BEANTYPE bean) throws IllegalStateException,
            IllegalArgumentException {
